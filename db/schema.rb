...
ActiveRecord::Schema.define(version: 2019_10_03_103314) do
  ...
  create_table "bargains", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "sender_id"
